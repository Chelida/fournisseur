...
import 'package:le_fournisseur/models/CommandeItems.dart';
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        centerTitle: true,
        title: Text("Details commande: widget.commande.reference",
            style: TextStyle(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        ListTile(
                          ...
                          subtitle: Text("${widget.commande.montantht} FCFA",
                            style: TextStyle(fontSize: 13,fontFamily: 'Montserrat',
                            fontWeight: FontWeight.w700,),),
                        ...
                        ListTile(
                          ...
                          subtitle: Text("${widget.commande.montantttc} FCFA",
                            style: TextStyle(fontSize: 13,fontFamily: 'Montserrat',
                            fontWeight: FontWeight.w700,),),
                        ...
                        ListTile(
                          ...
                          subtitle: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('${widget.commande.moyen_paiement}',
                                style: TextStyle(
                                    fontSize: 15,
                                    fontFamily: 'Montserrat',
                                    fontWeight: FontWeight.w600
                        ...
                        ListTile(
                          ...
                          subtitle: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('${widget.commande.reste} FCFA',
                                style: TextStyle(
                                    fontSize: 15,
                                    fontFamily: 'Montserrat',
                                    fontWeight: FontWeight.w600
