...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: Image.asset('assets/images/Logo-founisseur.png',width: 100,height: 100,),
        elevation: 0.0,
        centerTitle: true,
        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              ...
              children: [
                GestureDetector(
                  ...
                  child: CircleAvatar(
                    backgroundImage: avatar!=null?NetworkImage(avatar):AssetImage('assets/images/Logo-founisseur.png'),
                    radius: 22,
            ...
            GridView.count(
              ...
              shrinkWrap: true,
              children: <Widget>[
                _buildCard('Mes Commandes (22)''','Tom', 'Consulter vos bons de commande', 'assets/images/order.png','Commande'),
                _buildCard('Mes Factures','Tom', 'Mes factures', 'assets/images/billing.png','Facture'),
                _buildCard('Mes livraisons (41)','Tom', 'Consulter vos bons de livraison', 'assets/images/shipping.png','Livraison'),
                _buildCard('Mon relevé ','Tom', 'Historique des transactions', 'assets/images/invoice.png','Versement'),
              ],
            )
          ],
        ),
  ...
  Widget _buildCard(String title,String name, String description, String image,String url) {
